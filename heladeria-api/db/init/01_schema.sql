-- ============================================================================
-- Migración inicial: Esquema de base de datos para Seminario Integrador (UTN)
-- Basado en: DER SI.drawio.svg
-- Motor: PostgreSQL (compatible con Supabase SQL Editor)
-- ============================================================================
...
-- 3. CLIENTE (herencia: PK compartida con USUARIO)
...
-- 12. PAGO (0,1 por pedido → UNIQUE en id_pedido)
CREATE TABLE pago (
...
-- 14. DETALLE_PEDIDO (Contiene + Corresponde a)
...
-- 15. DETALLE_PEDIDO_SABOR (M:N — Incluye)
...
-- 16. DETALLE_PEDIDO_ADICIONAL (M:N — Agrega)
...
INSERT INTO sabor (nombre, stock_baldes, disponible, cap_balde) VALUES
    ('Chocolate',      20, true, '5L'),
    ('Vainilla',       25, true, '5L'),
    ('Frutilla',       15, true, '5L'),
    ('Dulce de Leche', 30, true, '5L'),
    ('Limón',          18, true, '5L'),
    ('Menta Granizada',12, true, '5L');

INSERT INTO adicional (nombre, precio_extra, disponible) VALUES
    ('Granas de Chocolate',  150.00, true),
    ('Granas de Colores',    120.00, true),
    ('Salsa de Chocolate',   200.00, true),
    ('Salsa de Dulce de Leche', 200.00, true),
    ('Crema',                180.00, true),
    ('Cereza',               250.00, true),
    ('Oblea',                100.00, true);

INSERT INTO producto (nombre, stock_envases, precio_base, max_sabores, id_categoria) VALUES
    ('Pote 1/4 kg',      50, 2500.00, 2, 1),
    ('Pote 1/2 kg',      40, 4200.00, 3, 1),
    ('Pote 1 kg',        30, 7500.00, 4, 1),
    ('Palito Frutal',    60, 1200.00, 0, 2),
    ('Palito Chocolate', 55, 1500.00, 0, 2),
    ('Postre Bombón',    25, 3200.00, 1, 3),
    ('Postre Suflé',     20, 3800.00, 1, 3);
